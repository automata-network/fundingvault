...
const VaultPage = (): React.ReactElement => {
  ...
  const managerCheck = useReadContract(
    chain
      ? {
  ...
  var isManager =
    isConnected && chain && managerCheck.isSuccess && managerCheck.data;
      ...
      <Suspense fallback={null}>
        <div className="foreground-container">
          ...
          <div className="page-wrapper container-fluid">
            <Routes>
              <Route path="/" element={<VaultInfo />} />
              <Route
                path="/manage"
                element={isManager ? <GrantList /> : null}
              />
            </Routes>
          </div>
